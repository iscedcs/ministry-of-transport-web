      ...
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 sm:px-6 py-4">
        ...
        <div className="flex items-center gap-2 md:hidden">
          <Button
            ...
            size="sm"
            variant="outline"
            className="text-xs h-8 px-3 rounded-lg border-primary/40 text-primary">
            <Link href="/login">Sign In</Link>
          </Button>
          <button
        ...
        <div className="md:hidden border-b border-border/60 bg-card/95 backdrop-blur-xl px-6 py-5 shadow-2xl animate-in slide-in-from-top-4 duration-300">
          <nav className="flex flex-col gap-4 text-sm font-medium">
            ...
            <div className="pt-2 flex flex-col gap-2">
              <Button
                asChild
                className="w-full rounded-xl font-semibold justify-center">
              ...
              <Button
                asChild
                variant="outline"
                className="w-full rounded-xl font-medium justify-center text-xs">
