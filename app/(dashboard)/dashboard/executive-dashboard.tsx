...
export function ExecutiveDashboard({
  ...
  const sectors =
    initialStats?.sectorData?.length > 0 ? initialStats.sectorData : sectorData;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="shadow-sm border-border bg-gradient-to-br from-background to-secondary/30">
          <CardHeader>
            ...
            <CardDescription>
              Quick links for administrative operations
            </CardDescription>
          </CardHeader>
          <CardContent className="grid grid-cols-2 gap-3">
            <Button
              variant="outline"
              className="h-auto py-4 flex flex-col items-center justify-center gap-2 hover:border-blue-500 hover:text-blue-600 transition-all">
              <Users className="w-6 h-6 mb-1 text-blue-500" />
              <span className="text-sm font-medium">Manage Staff</span>
            </Button>
            <Button
              variant="outline"
              className="h-auto py-4 flex flex-col items-center justify-center gap-2 hover:border-emerald-500 hover:text-emerald-600 transition-all">
              <CheckCircle2 className="w-6 h-6 mb-1 text-emerald-500" />
              <span className="text-sm font-medium">Bulk Approvals</span>
            </Button>
            <Button
              variant="outline"
              className="h-auto py-4 flex flex-col items-center justify-center gap-2 hover:border-amber-500 hover:text-amber-600 transition-all">
              <AlertCircle className="w-6 h-6 mb-1 text-amber-500" />
              <span className="text-sm font-medium">Incident Reports</span>
            </Button>
            <Button
              variant="outline"
              className="h-auto py-4 flex flex-col items-center justify-center gap-2 hover:border-purple-500 hover:text-purple-600 transition-all">
