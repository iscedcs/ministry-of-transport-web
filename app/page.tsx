      ...
      <main className="relative bg-background text-foreground">
          ...
          <div className="relative z-10 mx-auto w-full max-w-6xl px-6 py-20 text-center md:py-32">
            <div className="space-y-6">
              ...
              <p className="mx-auto max-w-2xl text-lg md:text-xl leading-relaxed text-white drop-shadow-xl">
                A single, modern platform for all transport operations: motor
                park approvals, fleet registration, vehicle inspection, and
        ...
        <section id="modules" className="mx-auto w-full max-w-6xl px-6 py-16">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {coreServices.slice(0, 4).map((module) => {
            ...
            <Card className="border-border/70 bg-card/60">
              ...
              <CardContent className="space-y-3 text-sm leading-relaxed text-muted-foreground">
                <p>
                  ...
                  partnership. The Ministry pays nothing upfront. All
                  development and hosting costs are covered by the implementing
                  partner.
                </p>
                <p>
            ...
            <Card className="border-border/70 bg-card/60">
              ...
              <CardContent className="space-y-3 text-sm leading-relaxed text-muted-foreground">
                <p>
                  ...
                  You&apos;ll need your Anambra State Identification Number
                  (ASIN) to create an account and submit applications online.
                </p>
                <p>
