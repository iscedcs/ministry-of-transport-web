...
async function main() {
  ...
  // Delete old template if exists to allow clean re-seeding of split access/amenities items
  try {
    await db.inspectionChecklistTemplate.delete({
      where: { id: "template-motor-park-initial" },
    });
    console.log("   - Cleaned existing initial checklist template");
  } catch {}
  ...
  const motorParkTemplate = await db.inspectionChecklistTemplate.upsert({
    ...
    create: {
      ...
      items: {
        create: [
          {
            itemName: "Conveniences",
            itemCategory: "conveniences",
            description: "Toilets and restrooms evaluated for cleanliness and capacity",
            isRequired: true,
            sortOrder: 1,
            maxPoints: 20,
          },
          {
            itemName: "Office Building",
            itemCategory: "operations",
            description: "Administrative office building on site",
            isRequired: true,
            sortOrder: 2,
            maxPoints: 5,
          },
          {
            itemName: "Water Source",
            itemCategory: "utilities",
            description: "Reliable water source (e.g. borehole or public main)",
            isRequired: true,
            sortOrder: 3,
            maxPoints: 15,
          },
          {
            itemName: "Distinct Entrance/Exit Gate",
            itemCategory: "access",
            description: "Separated entry and exit points for smooth traffic flow",
            isRequired: true,
            sortOrder: 4,
            maxPoints: 5,
          },
          {
            itemName: "Lighting (solar powered)",
            itemCategory: "utilities",
            description: "Solar powered illumination across the facility",
            isRequired: true,
            sortOrder: 5,
            maxPoints: 5,
          },
          {
            itemName: "Ticketing Point/Office",
            itemCategory: "operations",
            description: "Dedicated space for passenger ticketing",
            isRequired: true,
            sortOrder: 6,
            maxPoints: 5,
          },
          {
            itemName: "Restaurant/Shops",
            itemCategory: "amenities",
            description: "Food and retail stalls/shops for passengers",
            isRequired: true,
            sortOrder: 7,
            maxPoints: 5,
          },
          {
            itemName: "Passenger Waiting Area",
            itemCategory: "amenities",
            description: "Covered, comfortable seating area for passengers",
            isRequired: true,
            sortOrder: 8,
            maxPoints: 5,
          },
          {
            ...
            description: "Certified fire safety equipment present and accessible",
            isRequired: true,
            sortOrder: 9,
            maxPoints: 5,
          },
          {
            itemName: "Perimeter Fence",
            itemCategory: "infrastructure",
            description: "Secured boundary fence surrounding the facility",
            isRequired: true,
            sortOrder: 10,
            maxPoints: 10,
          },
          {
            itemName: "Space is paved",
            itemCategory: "infrastructure",
            description: "Ground area paved to prevent mud/dust and organize parking",
            isRequired: true,
            sortOrder: 11,
            maxPoints: 10,
          },
          {
            itemName: "Presence of Waste Bin",
            itemCategory: "utilities",
            description: "Strategic placement of waste disposal bins",
            isRequired: true,
            sortOrder: 12,
            maxPoints: 5,
          },
          {
            itemName: "Security Cameras",
            itemCategory: "utilities",
            description: "CCTV/Security cameras covering major sections",
            isRequired: true,
            sortOrder: 13,
            maxPoints: 5,
          },
  ...
  // ==================== DEFAULT STAFF USERS ====================
  console.log("\n🌱 Seeding default staff users (Password: Password123)...");
  ...
  const defaultUsers = [
    {
      ...
      stationLocation: null as string | null,
    },
    {
      ...
      passwordHash: defaultPasswordHash,
      isActive: true,
      designation: "Honorable Commissioner",
      departmentId: null as string | null,
      stationLocation: null as string | null,
    },
    {
    ...
    },
    {
      ...
      firstName: "Obinna",
      lastName: "Anayo",
      role: "HOD_PARKS" as const,
      passwordHash: defaultPasswordHash,
      departmentId: "parks" as string | null,
      isActive: true,
      designation: "HOD Motor Parks & Terminals",
      stationLocation: null as string | null,
    },
    {
      id: "user-hod-vis",
      ...
      lastName: "Okafor",
      role: "HOD_VIS" as const,
      passwordHash: defaultPasswordHash,
      departmentId: "vis" as string | null,
      isActive: true,
      designation: "HOD Vehicle Inspection Services",
      stationLocation: null as string | null,
    },
    {
      id: "user-field-inspector",
      email: "inspector@mot.anambra.gov.ng",
      firstName: "Emeka",
      lastName: "Nduka",
      role: "FIELD_INSPECTOR" as const,
      passwordHash: defaultPasswordHash,
      isActive: true,
      designation: "Senior Field Inspector",
      stationLocation: "Awka South" as string | null,
      departmentId: null as string | null,
    },
  ];
