...
export async function updateMotorParkStatus(
  ...
  try {
    ...
    const validTransitions: Record<ApplicationStatus, ApplicationStatus[]> = {
      ...
      INSPECTION_COMPLETED: ["PENDING_APPROVAL", "PENDING_HOD_APPROVAL"],
      PENDING_APPROVAL: ["APPROVED", "REJECTED"],
      PENDING_HOD_APPROVAL: ["PENDING_COMMISSIONER_APPROVAL", "REJECTED"],
      PENDING_COMMISSIONER_APPROVAL: ["PENDING_PS_APPROVAL", "REJECTED"],
      PENDING_PS_APPROVAL: ["APPROVED", "REJECTED"],
